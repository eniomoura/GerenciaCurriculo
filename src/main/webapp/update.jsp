...
<body style="text-align: center;">
	...
	<form>
		...
		<p> Endereço </p>
		<p><input type= "text" name = "endereço" value = <%= request.getParameter("endereco") %>></input></p>
		...
		<p> Formação </p>
		<p><input type= "text" name = "formaçao" value = <%= request.getParameter("formacao") %>></input></p>
		
		<p> Experiência </p>
		<p><input type= "text" name = "experiencia" value = <%= request.getParameter("experiencia") %>></input></p>
		
		<p> Remuneração Desejada </p>
		<p><input type= "text" name = "remuneraçao" value = <%= request.getParameter("remuneracao") %>></input></p>
